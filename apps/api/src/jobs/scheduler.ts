 ...
 * Her iş idempotent olmak zorunda (iki kez koşarsa ikinci koşu boş döner) — takip taraması
 * öyle. İlk koşu açılıştan 1 dk sonra: DB/migrasyon henüz hazır değilse patlamasın.
 * ⚠ Çoklu süreçte (pm2 cluster) her süreç tarar; şimdilik tek süreç (docs/02 KARAR-14).
 */
export function startScheduler(jobs: { followUp: FollowUpService }, intervalMin: number) {
